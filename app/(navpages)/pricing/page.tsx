    ...
    <div className="font-[sans-serif] bg-gray-100 px-4 py-8">
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto">
        ...
        <div className="flex mx-auto bg-white rounded-full max-w-[300px] p-1 mt-6">
          <button className="w-full text-sm bg-purple-600 text-white py-2 px-4 tracking-wide rounded-full">
            Monthly</button>
          <button
        ...
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 max-sm:max-w-sm max-sm:mx-auto mt-12">
          ...
          <div className="bg-white shadow rounded-3xl p-6 hover:scale-105 transition-all duration-300">
            ...
            <div>
              ...
              <button type="button" className="w-full mt-6 px-4 py-2 text-sm tracking-wide bg-purple-600 hover:bg-purple-700 text-white rounded-xl">Get Started</button>
            </div>
          </div>
          ...
          <div className="bg-white shadow rounded-3xl p-6 hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-4xl font-semibold ">$24.50<sub className="text-gray-500 font-medium text-sm ml-1">/ month</sub></h3>
